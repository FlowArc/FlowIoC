...
{
    public class ModuleScannerRunnerTests
    {
        ...
        public void Every_module_gets_a_row_carrying_one_finding_per_check()
        {
            ...
            ModuleScannerReportEVO report = new ModuleScannerRunner(pipeline)
        ...
        public void Scanning_never_calls_Fix()
        {
            ...
            new ModuleScannerRunner(pipeline).Run(new ProjectTargetEVO(), new[] {Target("PlayerModule")});
