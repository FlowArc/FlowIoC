...
{
    public class ModuleScanStartupReportTests
    {
        private static ModuleScanReportEVO ReportWith(params ModuleCheckStatus[] moduleStatuses)
        {
        ...
        {
            Assert.IsNull(new ModuleScanStartupReport().LineFor(ReportWith(ModuleCheckStatus.Ok)));
        }

        [Test]
        public void A_report_that_does_not_exist_produces_no_line()
        {
            Assert.IsNull(new ModuleScanStartupReport().LineFor(null));
        }

        [Test]
        public void The_line_counts_the_issues_the_modules_they_are_in_and_names_the_menu()
        {
            string line = new ModuleScanStartupReport()
        ...
        public void A_project_level_issue_alone_still_produces_a_line()
        {
            ...
            Assert.IsNotNull(new ModuleScanStartupReport().LineFor(report));
        }
    }
}
