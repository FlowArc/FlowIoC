...
namespace FlowIoC.Tests
{
    public class ModuleSelectionRulesTests
    {
        ...
        /// Screen or Test module; a new Screen module cannot nest under a Test module; a new
        /// Test module cannot nest under another Test module - it attaches to the module it
        /// tests, not to a peer test module. A new Sub module has no restriction at all. This is
        /// the one rule in the module-hierarchy tree that regressed silently during the shared-
        /// drawer refactor, so every one of the sixteen combinations is pinned here rather than
        /// spot-checked.
        /// </summary>
        ...
        [TestCase(ModuleKind.Screen, ModuleKind.Screen, true)]
