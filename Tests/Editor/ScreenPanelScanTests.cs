...
namespace FlowIoC.Tests
{
    ...
    /// </summary>
    public class ScreenPanelScanTests
    {
        ...
        [SetUp]
        public void SetUp() => _scan = new ScreenPanelScan(new ScreenSubContextDeclarations());
        ...
        public void A_context_that_is_not_a_screen_produces_no_row()
        {
            ...
            {
                ContextFullName = typeof(ScreenPanelScanTests).FullName,
                ContextName = nameof(ScreenPanelScanTests)
            });
