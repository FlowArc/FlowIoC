    ...
    internal class CodeGeneratorsPage : HelpPage
    {
        ...
        protected override void DrawBody(HelpPainter painter)
        {
            painter.Paragraph(
                ...
                + "than copying a folder: a copied module carries the original's namespace, its "
                + "assembly name and its _module_info.txt, and every other tool keeps finding the "
                + "module it was copied from.");
            ...
            painter.Paragraph(
                "It writes the folder tree, Modules.<Name>.asmdef, the _module_info.txt that "
                + "describes the module, and - unless you clear the toggles - the Root and Context "
                + "pair. For a Screen module you can list the screen's actions up front, and they "
                + "are put on both the View and the Mediator.");
