...
namespace FlowIoC.Editor.Help.Pages.Modules
{
    ...
    internal class CounterModulePage : HelpPage
    {
        ...
        protected override void DrawBody(HelpPainter painter)
        {
            ...
            painter.Bullet(
                "It measures forward as well as down. CountUpFrom counts up from a moment "
                + "in the past, with or without an end.");
            painter.Bullet(
                "Nothing has to wait for it. A counter asked for before the module is up is "
                + "held, and starts on its own once the time source answers.");

            painter.Space();
            painter.Note(
                "It is a Service, so another module references Modules.Counter and injects "
            ...
            painter.Paragraph(
                ...
                + "it. Open CounterTestScene under the test module's Scenes folder and press "
        ...
        private void DrawUsage(HelpPainter painter)
        {
            ...
            painter.Code(
                ...
                + "\n"
                + "DateTime? startedAt = _counter.CountDownInstantly(\"chest\", 3600,\n"
            ...
            painter.Code(
                "_counter.CountDownFrom(\"chest\", 3600, savedStartTime,\n"
            ...
            painter.Code(
                "_counter.CountUpFrom(\"session\", sessionStart,\n"
                + "    checkActive: null,\n"
        ...
        private void DrawTimeSource(HelpPainter painter)
        {
            ...
            painter.Paragraph(
                "A player who moves the device clock moves every counter with it. A game that "
            ...
            painter.Paragraph(
                ...
                + "IsActive is false, GetTime returns null, and counters asked for meanwhile wait "
