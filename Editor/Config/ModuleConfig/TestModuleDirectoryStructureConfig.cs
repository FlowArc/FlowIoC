...
{
    [CreateAssetMenu(fileName = "TestModuleDirectoryStructureConfig", menuName = "FlowIoC/Editor/CodeGenerator/TestModule Directory Structure Config")]
    public class TestModuleDirectoryStructureConfig : DirectoryStructureConfig
    {
        ...
        protected internal override List<FolderConfig> RootFolders { get; protected set; } = new List<FolderConfig>
        {
            ...
            new FolderConfig
            {
                ...
                SubFolders = new List<FolderConfig>
                {
                    ...
                    new FolderConfig
                    {
                        FolderName = "Editor", Type = FolderConfig.FolderType.Editor, IsMandatory = true
                    }
                },
                Type = FolderConfig.FolderType.Folder,
                IsMandatory = true, 
            ...
            new FolderConfig
            {
                FolderName = "zSubModules", Type = FolderConfig.FolderType.SubModules, IsMandatory = false, IsNamespaceProvider = false
            },
            new FolderConfig
            {
                FolderName = "zTestModules", Type = FolderConfig.FolderType.TestModules, IsMandatory = false, IsNamespaceProvider = false
            },
            new FolderConfig
            {
                FolderName = "zScreenModules", Type = FolderConfig.FolderType.ScreenModules, IsMandatory = false, IsNamespaceProvider = false
            }
        };
        ...
        public static DirectoryStructureConfig GetOrCreateConfig(string configKey)
        {
            ...
            TestModuleDirectoryStructureConfig config = AssetDatabase.LoadAssetAtPath<TestModuleDirectoryStructureConfig>(configPath);
            ...
            if (config == null)
            {
                ...
                config = CreateInstance<TestModuleDirectoryStructureConfig>();
        ...
        protected override void InitializeDefaultFolderStructure()
        {
            ...
            RootFolders = new List<FolderConfig>
            {
                ...
                {
                    CreateFolder(codeGenSettings.DirectoryStructureConfigMap[FolderConfig.FolderType.ScreenConfigs], FolderConfig.FolderType.ScreenConfigs, null, false, true,true)
                },false, true, true),
                CreateFolder("Scripts", FolderConfig.FolderType.Folder, new List<FolderConfig>
                {
                    CreateFolder("Runtime", FolderConfig.FolderType.Folder, new List<FolderConfig>
                    {
                        ...
                        CreateFolder(codeGenSettings.DirectoryStructureConfigMap[FolderConfig.FolderType.Models], FolderConfig.FolderType.Models, null, true, isNamespaceProvider: true),
                        CreateFolder("Enums", FolderConfig.FolderType.Folder, null, false, true, isNamespaceProvider: true),
                        CreateFolder(codeGenSettings.DirectoryStructureConfigMap[FolderConfig.FolderType.RootsAndContexts], FolderConfig.FolderType.RootsAndContexts, null, true, isNamespaceProvider: true),
                ...
                CreateFolder(codeGenSettings.DirectoryStructureConfigMap[FolderConfig.FolderType.SubModules], FolderConfig.FolderType.SubModules, null, false, false, false),
                CreateFolder(codeGenSettings.DirectoryStructureConfigMap[FolderConfig.FolderType.TestModules], FolderConfig.FolderType.TestModules, null, false, false,false),
                CreateFolder(codeGenSettings.DirectoryStructureConfigMap[FolderConfig.FolderType.ScreenModules], FolderConfig.FolderType.ScreenModules, null, false, false, false)
            };
        }
