...
{
    [CreateAssetMenu(fileName = "ED_ScreenModuleDirectoryStructure",
        menuName = "FlowIoC/Editor/CodeGenerator/ScreenModule Directory Structure Config")]
    public class ED_ScreenModuleDirectoryStructure : DirectoryStructureConfig
    {
        ...
        public static DirectoryStructureConfig GetOrCreateConfig(string configKey)
        {
            ...
            ED_CodeGenerator settings = AssetDatabase.LoadAssetAtPath<ED_CodeGenerator>(settingsPath);
            if (settings == null)
            {
            ...
            ED_ScreenModuleDirectoryStructure config = AssetDatabase.LoadAssetAtPath<ED_ScreenModuleDirectoryStructure>(configPath);
            ...
            if (config == null)
            {
                ...
                config = CreateInstance<ED_ScreenModuleDirectoryStructure>();
            ...
            RootFolders = new List<FolderEVO>
            {
                ...
                CreateFolder("Scriptables", FolderEVO.FolderType.Folder, new List<FolderEVO>
                {
                    CreateFolder(codeGenSettings.DirectoryStructureConfigMap[FolderEVO.FolderType.ScreenConfigs],
                        FolderEVO.FolderType.ScreenConfigs, null, true, false, true)
                }, true, false, true),
                CreateFolder("Scripts", FolderEVO.FolderType.Folder, new List<FolderEVO>
                {
                    CreateFolder("Runtime", FolderEVO.FolderType.Folder, new List<FolderEVO>
                    {
                        ...
                        CreateFolder(codeGenSettings.FolderNameFor(FolderEVO.FolderType.Signals, "Signals"),
                            FolderEVO.FolderType.Signals, null, true),
                        ...
                        CreateFolder("Functions", FolderEVO.FolderType.Folder, null, true),
