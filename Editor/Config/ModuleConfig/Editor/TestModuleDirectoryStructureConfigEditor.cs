...
{
    [CustomEditor(typeof(TestModuleDirectoryStructureConfig))]
    public class TestModuleDirectoryStructureConfigEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            base.OnInspectorGUI();

            TestModuleDirectoryStructureConfig config = target as TestModuleDirectoryStructureConfig;
            if (config == null)
                return;
