...
{
    [CustomEditor(typeof(MainModuleDirectoryStructureConfig))]
    public class MainModuleDirectoryStructureConfigEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            base.OnInspectorGUI();

            MainModuleDirectoryStructureConfig config = target as MainModuleDirectoryStructureConfig;
            if (config == null)
                return;
