...
{
    [CreateAssetMenu(fileName = "ScreenModuleDirectoryStructureConfig", menuName = "FlowIoC/Editor/CodeGenerator/ScreenModule Directory Structure Config")]
    public class ScreenModuleDirectoryStructureConfig : DirectoryStructureConfig
    {
        ...
        protected override void InitializeDefaultFolderStructure()
        {
            ...
            RootFolders = new List<FolderConfig>
            {
                ...
                {
                    CreateFolder(codeGenSettings.DirectoryStructureConfigMap[FolderConfig.FolderType.ScreenConfigs], FolderConfig.FolderType.ScreenConfigs, null, true, false,true)
                },true, false, true),
                CreateFolder("Scripts", FolderConfig.FolderType.Folder, new List<FolderConfig>
                {
                    CreateFolder("Runtime", FolderConfig.FolderType.Folder, new List<FolderConfig>
                    {
                        ...
                        CreateFolder(codeGenSettings.DirectoryStructureConfigMap[FolderConfig.FolderType.Services], FolderConfig.FolderType.Services, null, false, true),
