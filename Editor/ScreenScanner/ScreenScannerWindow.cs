...
namespace FlowIoC.Editor.ScreenScanner
{
    ...
    /// </summary>
    internal class ScreenScannerWindow : EditorWindow
    {
        /// <summary>What the panel is called, in the menu, on the tab and on its bar.</summary>
        private const string TITLE = "Screen Scanner";
        ...
        private void OnGUI()
        {
            ...
            _bar.DrawWindow(
                _painter.Bar, _painter.Ok, TITLE, "FlowIoC", "Every screen in the open scenes", "Refresh", Refresh,
                TITLE);
