...
namespace FlowIoC.Editor.ModuleScan
{
    ...
    /// </summary>
    internal class ModuleScanStartupReport
    {
        internal string LineFor(ModuleScanReportEVO report)
        {
            if (report == null || report.IssueCount == 0) return null;

            return "<color=cyan>FlowIoC:</color> Module Scan found "
        ...
        internal void Report()
        {
            ...
            string line = LineFor(new ModuleScanRunner(new ModuleCheckPipeline()).Run(project, modules));
