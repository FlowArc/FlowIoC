...
namespace FlowIoC.Editor.CodeGenerator.Menus
{
    internal class CreateCommandMenu : EditorWindow
    {
        ...
        private const string MODULE_INFO_FILE = "module_info.txt";
        ...
        private void CreateModuleStructureForCommandGeneration()
        {
            ...
            string commandPath = _directoryConfigMap[_selectedModuleType].FindFullFolderPathByID(FolderConfig.FolderType.Controllers, modulePath);
        ...
        private void CreateCommand(string path, string moduleNamespace)
        {
            ...
            EnsureNamespaceImport(commandName, path, $"{codeGenSettings.DirectoryStructureConfigMap[FolderConfig.FolderType.Controllers]}", moduleNamespace);
        }
