...
`Assets/FlowIoC/Generated/FlowLogType.cs` as `const int` fields.
...
*Tools ▸ FlowIoC ▸ Module Configuration ▸ Detect & Fix Module Infos*. Never edit
`Assets/FlowIoC/Generated/FlowLogType.cs` by hand; it is overwritten.
