...
{
    /// <summary>
    /// A countdown that is running, and everyone listening to it. Several callers may share one
    ...
    public class CountdownVO
    {
        ...
        /// <summary>
        /// Drops every callback once the countdown is over. The lists are emptied rather than
