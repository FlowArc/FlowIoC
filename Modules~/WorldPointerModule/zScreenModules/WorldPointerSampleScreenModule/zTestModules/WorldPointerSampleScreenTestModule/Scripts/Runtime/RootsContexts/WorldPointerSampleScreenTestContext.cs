...
namespace Modules.WorldPointerModule.WorldPointerSampleScreenModule.WorldPointerSampleScreenTestModule.RootsContexts
{
    /// <summary>
    ...
    public class WorldPointerSampleScreenTestContext : BaseScreenContext
    {
        public override void Launch()
        {
            base.Launch();
			_screenService.Open<WorldPointerSampleScreenView>().Show();
