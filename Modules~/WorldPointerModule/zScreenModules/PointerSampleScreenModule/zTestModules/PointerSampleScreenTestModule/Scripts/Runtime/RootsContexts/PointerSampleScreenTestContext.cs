...
namespace Modules.WorldPointerModule.PointerSampleScreenModule.PointerSampleScreenTestModule.RootsContexts
{
    /// <summary>
    ...
    public class PointerSampleScreenTestContext : BaseScreenContext
    {
        public override void Launch()
        {
            base.Launch();
			_screenService.Open<PointerSampleScreenView>().Show();
