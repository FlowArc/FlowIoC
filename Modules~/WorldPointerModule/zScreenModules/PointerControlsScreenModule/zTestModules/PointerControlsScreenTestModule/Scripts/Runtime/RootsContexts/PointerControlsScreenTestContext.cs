...
namespace Modules.WorldPointerModule.PointerControlsScreenModule.PointerControlsScreenTestModule.RootsContexts
{
    /// <summary>
    ...
    public class PointerControlsScreenTestContext : BaseScreenContext
    {
        public override void Launch()
        {
            base.Launch();
			_screenService.Open<PointerControlsScreenView>().Show();
